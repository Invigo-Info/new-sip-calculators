...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initialize slider fill styling to match monthly page
    initRangeFills();
    calculateAndUpdate();
});
...
// Visually fill range input using CSS background-size (matches monthly page)
    ...
    sipBreakupChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: [
                    '#3c83f6',  // Total Invested (matches index)
                    '#16a249'   // Expected Returns (matches index)
                ],
                borderWidth: 0,
                hoverOffset: 15
            }]
