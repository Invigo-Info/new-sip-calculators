...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initialize slider fill backgrounds
    initRangeFills();
...
function initialSyncReverseCagrValues() {
    ...
    // Update initial fill visuals
    updateRangeFill(reverseCagrTargetAmountSlider);
    updateRangeFill(reverseCagrExpectedReturnSlider);
    updateRangeFill(reverseCagrInvestmentYearsSlider);
}
...
// Range fill helpers (apply to any .custom-slider)
